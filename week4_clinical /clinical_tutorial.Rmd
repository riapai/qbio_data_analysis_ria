...
par(mar=c(5,1,1,1))
boxplot( clinic$age_at_initial_pathologic_diagnosis ~ clinic$vital_status, xlab = "Age at initial diagnosis", ylab = "Vital Status", main = "Age of initial diagnosis vs. Vital Status", las = 2, cex.axis = 0.5)
```
...
```{r}
clinic$survival_time <- ifelse( is.na(clinic$days_to_death), days_to_last_follow_up, clinic$days_to_death )
```
